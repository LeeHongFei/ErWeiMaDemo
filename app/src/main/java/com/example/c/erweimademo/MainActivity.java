package com.example.c.erweimademo;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void make(View view) {
        ...
        if (input.equals("")){
            ...
            Bitmap qrCode = EncodingUtils.createQRCode(input, 500, 500,mCheckBox.isChecked()? BitmapFactory.decodeResource(getResources(),R.mipmap.ic_launcher):null);
